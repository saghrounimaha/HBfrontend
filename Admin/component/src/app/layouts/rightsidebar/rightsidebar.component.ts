...
import { LAYOUT_VERTICAL, LAYOUT_THEME, LAYOUT_WIDTH, LAYOUT_POSITION, TOPBAR, SIDEBAR_SIZE, SIDEBAR_VIEW, SIDEBAR_COLOR, SIDEBAR_IMAGE, DATA_PRELOADER } from '../layout.model';
...
export class RightsidebarComponent {
  ...
  constructor(private eventService: EventService, private renderer: Renderer2, private elementRef: ElementRef) { }
  ngOnInit(): void {
